    ...
    public RegistroHuesped() {
        ...
        btnguardar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Huesped huesped = new Huesped(0, nombre, apellido, fechaNacimiento, nacionalidad, telefono, idReserva);

                boolean insercionExitosa = conexionBD.insertarHuesped(huesped);
